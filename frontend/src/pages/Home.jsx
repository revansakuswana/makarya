              ...
              <Box className="mx-auto max-w-7xl content-center sm:static ">
                <Box className="lg:max-w-lg flex flex-col gap-5">
                  ...
                  <Typography
                    ...
                    Temukan <span style={{ color: "#336aea" }}>Pekerjaan</span>{" "}
        ...
        <Box
          ...
          <Box sx={{ textAlign: "center", mb: 4 }}>
            ...
            <Typography
              ...
              Pekerjaan <span style={{ color: "#336aea" }}>terbaru</span> minggu
              ini.
            </Typography>
                    ...
                    {visibleData.length > 0 ? (
                      ...
                      <Box className="flex flex-col items-center text-center">
                        ...
                        <Typography variant="h5" fontWeight="bold">
                          Tidak ada pekerjaan yang ditemukan untuk pencarian ini
                        </Typography>
